<x-admin-layout>
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">班一覧</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">班マスター</a>
                            </li>
                            <li class="breadcrumb-item active">班一覧
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="card-body border-bottom">
                            <div class="d-flex justify-content-between align-items-center header-actions mx-2 row mt-75">
                                <div class="col-sm-12 col-lg-4 d-flex justify-content-center justify-content-lg-start">
                                    <h4 class="card-title mb-0">班一覧</h4>
                                </div>
                                    ...
                                    <div class="dt-action-buttons d-flex align-items-center justify-content-center justify-content-lg-end flex-lg-nowrap flex-wrap">
                                        <div class="dt-buttons">
                                            <button class="dt-button add-new btn btn-primary" tabindex="0"
                                                    ...
                                                    data-bs-target="#modals-slide-in"><span>班追加</span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <table class="datatables-ajax table table-responsive" id="admin-table">
                                ...
                                @foreach($data as $item)
                                    <tr>
                                        ...
                                        <td>{{$item->name}}</td>
                                        <td>{{isset($item->teamManager) ? $item->teamManager->name : ''}}</td>
                                        <td>
        ...
        <div class="modal-dialog">
            <form class="add-new-user modal-content pt-0" id="company_add">
                ...
                <div class="modal-header mb-1">
                    <h5 class="modal-title" id="exampleModalLabel">班追加</h5>
                </div>
                <div class="modal-body flex-grow-1">
                    <div class="mb-1">
                        <label class="form-label" for="basic-icon-default-uname">営業所名</label>
                    ...
                    <div class="mb-1">
                        <label class="form-label" for="basic-icon-default-fullname">班名</label>
                        <input type="text" class="form-control dt-full-name" placeholder="班名" name="name" required/>
                    </div>
                    <div class="mb-1">
                        <label class="form-label" for="basic-icon-default-uname">班長</label>
                        <select class="form-select" name="team_manager_id">
                            <option></option>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel33">班変更</h4>
                ...
                <form id="modify_form">
                    ...
                    <div class="modal-body">
                        ...
                        <label>班名: </label>
                        <div class="mb-1">
                            <input type="text" class="form-control" placeholder="班名" name="name" id="name" required/>
                        </div>

                        <label>班長: </label>
                        <div class="mb-1">
                            <select class="form-select" name="team_manager_id" id="team_manager_id">
                                <option></option>
                                @foreach($users as $item)
                                    <option value="{{$item->id}}">{{$item->name}}</option>
                                @endforeach
    ...
    <script>
        let qualify_add = '{{route('master.team-save')}}';
        let qualify_delete = '{{route('master.team-delete')}}';
        // toastr.options = {
        //     "closeButton": true,
        //     "debug": false,
        //     "newestOnTop": false,
        ...
        $('.item-edit').click(function (e) {
            ...
            $("select#team_manager_id option").filter(function() {
                //may want to use $.trim in here
                return $(this).text() == app_name;
            }).prop('selected', true);
            let name = $(this).parent().prev().prev().prev().text();
            $("select#office_id option").filter(function() {
                //may want to use $.trim in here
