    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">業務委託一覧</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">業務委託一覧
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div class="card-datatable px-2" id="work_shift_total" style="width: 250% !important;">
                                <table class="datatables-ajax table table-responsive" id="admin-table">
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="18" class="text-center">給料項目</th>
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="11" class="text-center">手当（日給）　業務委託</th>
                                        <th colspan="5" class="text-center">控除項目（日額）</th>
                                        <th colspan="4" class="text-center">占部組　請求基本額</th>
                                    </tr>
                                    <tr>
                                        <th class="text-center">日給</th>
                                    ...
                                    @foreach($data as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">{{$item->helmet}}</td>
                                            <td class="text-center">{{$item->safe_cost}}</td>
                                            <td class="text-center">{{$item->insurance_cost}}</td>
                                            <td class="text-center">{{$item->business_phone}}</td>
